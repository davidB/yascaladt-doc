...
RoadMap (sorted with a balance between usefull priority and ease/time to implement):
...
- ** plugin that understand maven-scala-plugin and add/remove marker in code
